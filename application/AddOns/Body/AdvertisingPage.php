    ...
    <center>
      <div style="height:auto;background-color:black;color:white">
        <div class="avemargin">
          <center>
            <h2b>
              <?php echo $box1_rs['words']; ?>
            </h2b>
            <br>
            <p1>
              <?php echo $box1info_rs['words']; ?>
            </p1>
              </br>
            <h2b>
              <?php echo $box2_rs['words']; ?>
            </h2b>
                    <br>
            <p1>
           
              <?php echo $box2info_rs['words']; ?>
            </p1>
                      </br>
            <h2b>
              <?php echo $box3_rs['words']; ?>
            </h2b>
            ...
            <br>
            <a href="index.php?page=application/Links/AdvertisingQuestionnaire">
              <h4b> Contact Us </h4b>
            </a>
            </br>
          </center>
