...
<div class="form">
  ...
  <p>
    <a href="index.php?page=application/BackPages/Words/editDeliverypageupdate"><button type="submit" style="margin-top:8px;" class="button button-block" name="update" value="Update">Update</button></a> 
