<?php
	...
	if($_FILES['fileToUpload']['name']!="") {
		$_SESSION['addwine']['pic']=$_FILES['fileToUpload']['name'];
		$target_dir = "images/";
...
<center>
  ...
  <div class="text">
    <h1>Confirm item details</h1>
				...
				<p><?php echo $_SESSION['addBusinesses']['date']; ?></p>
				<p><?php echo $_SESSION['addBusinesses']['dis']; ?></p>
		...
		$_SESSION['addwine']['pic']="noimage.jpg";
		?>
		<div class="text">
				<p>NO PIC</p>
          <?php echo $_SESSION['addBusinesses']['price']; ?></p>
				<p>
            <?php echo $_SESSION['addBusinesses']['date']; ?></p>
				<p>
              <?php echo $_SESSION['addBusinesses']['dis']; ?></p>
